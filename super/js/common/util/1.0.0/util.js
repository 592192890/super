...
define(function(require, exports, module) {
    ...
    exports.filter = function(o, predicate) {
        var func, add, out = isArray(o) ?
            (func = forEach, add = function(i, v) {
                out.push(v)
            }, []) :
            (func = forIn, add = function(k, v) {
                out[k] = v
            }, {})
        func(o, function(v, i) {
            if (predicate(v, i)) {
        ...
        function deprecated() {
            if (!warned) {
                ...
                try {
                    ...
                    (0, eval)('console.warn("' + sb.join('\n').replace('Error:', 'Deprecate:').replace(/[\s\S]/g, function(a) {
                        return meta[a] || a;
                    }) + '")');
                }
                //>>excludeEnd("debug")
    ...
    exports.getHrefParam = function(name) {
    ...
    exports.getUrlParam = function(url, name) {
    ...
    exports.renderTmpl = function(template, tpl, data) {
