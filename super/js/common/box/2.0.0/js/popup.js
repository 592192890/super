...
define(function (require, exports, module) {
    ...
    var css = require('lib/core/1.0.0/utils/css');
    ...
    function Popup (options) {
        ...
        self.on('show', function(options) {
            ...
            if (options.modal) {
                ...
                self._mask.insertBefore($popup);
				setTimeout(function(){
					self._mask.addClass('ui-layer-mask-hover');
				},0);
        ...
        self.on('hide', function(options) {
			self._mask.removeClass('ui-layer-mask-hover');
			setTimeout(function(){
				self._mask.remove();
			}, 300);
            self._shadow.remove();
