...
define(function(require, exports, module) {
    ...
    var timeUrl = null;
    if(windowUrl == 'wx.yunhou.com'){
        timeUrl = '//wx.yunhou.com/super/api/time';
    }else if(windowUrl == 'ssl.yunhou.com'){
        timeUrl = '//ssl.yunhou.com/act/api/time';
    }else{
        timeUrl = '//api.mall.yunhou.com/Time';
    }
    
    function getNTP() {
        return context.getConf('env.ntp', timeUrl);
    }
